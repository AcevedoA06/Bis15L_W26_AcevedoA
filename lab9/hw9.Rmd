...
```{r}
sydneybeaches
#The data is "tidy" because it is in a wide format, showing all the different variables without repeating names in the same column nor does it have numbers with unconvential names that causes r to read them as chr instead of dbl
```

3. We are only interested in the variables site, date, and enterococci_cfu_100ml. Make a new object focused on these variables only. Name the object `sydneybeaches_long`
```{r}
syndeybeaches_long <- sydneybeaches %>% 

...
ggplot(data=homerange, 
  ...
  #Birds, Mammals, Reptiles and Ray Finned Fishes are included in the data set
```
...
```{r}
homerange %>% 
  select(trophic.guild, common.name, class, mean.hra.m2) %>% 
  filter(trophic.guild=="carnivore") %>% 
  filter(class=="mammalia") %>% 
  slice_max(mean.hra.m2, n=10)
 #The Cheetah, Leopard and Caracal have the 3 largest home ranges out of all the carnivorous mammals in the data set
```
